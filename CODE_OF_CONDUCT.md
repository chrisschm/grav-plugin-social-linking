...
community leaders responsible for enforcement at **conduct@jcs-net.de**. All complaints will be
...
Dieses Projekt übernimmt den [Contributor Covenant](https://www.contributor-covenant.org/de/version/2/1/code_of_conduct/),
Version 2.1, als Verhaltenskodex. Kurz zusammengefasst: Wir wollen eine offene, einladende und
belästigungsfreie Umgebung für alle Beteiligten, unabhängig von Alter, Herkunft, Geschlecht,
Religion oder anderen persönlichen Merkmalen. Respektvoller Umgang, konstruktives Feedback und
Verantwortungsübernahme bei Fehlern werden erwartet; Belästigung, beleidigende Kommentare oder das
Veröffentlichen privater Informationen anderer ohne Erlaubnis sind nicht akzeptabel.

Verstöße können gemeldet werden an: **conduct@jcs-net.de**. Meldungen werden vertraulich und
zeitnah geprüft. Der vollständige, verbindliche Text (oben in Englisch) enthält zusätzlich die
gestuften Konsequenzen bei Verstößen.
